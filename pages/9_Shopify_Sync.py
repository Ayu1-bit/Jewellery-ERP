...
st.title("🔗 Shopify Integration & Real-Time Sync")
...
if not client.configured:
    ...
    with tab_products:
        ...
        if st.button("⬇️ Sync Products Now", type="primary"):
    ...
    with tab_orders:
        ...
        if st.button("⬇️ Sync Orders Now", type="primary"):
    ...
    with tab_customers:
        ...
        if st.button("⬇️ Sync Customers Now", type="primary"):
    ...
    with tab_push:
        ...
        if not local_products:
            ...
            if st.button("⬆️ Push to Shopify", type="primary"):
                try:
                    payload = {
                        "product": {
                            "title": p["name"],
